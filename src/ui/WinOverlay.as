package ui 
{
	 ...
	 */
	public class WinOverlay extends FlxGroup
	{
		...
		public function WinOverlay() 
		{
			...
			var winText:FlxText = new FlxText(xLeft, yTop, TOTAL_WIDTH, "You have ESCAPED");
			winText.setFormat(null, 16, 0xffffff, "center", 0x400000);
			add(winText);
